                    ...
                    <div className="container mx-auto px-6">
                        <div className="grid md:grid-cols-4 gap-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-gray-200">
                                    <li><Link href="/help-center" className="hover:text-yellow-300 transition-colors">Help Center</Link></li>
                                    <li><Link href="#" className="hover:text-yellow-300 transition-colors">Contact Us</Link></li>
                                    <li><Link href="/privacy-policy" className="hover:text-yellow-300 transition-colors">Privacy Policy</Link></li>
                                    <li><Link href="/term-condition" className="hover:text-yellow-300 transition-colors">Terms of Service</Link></li>
                                </ul>
                            </div>
